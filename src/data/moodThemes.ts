...
export const MOOD_THEMES: Record<MoodLevel, MoodTheme> = {
  ...
  sleepy: {
    id: 'sleepy',
    name: 'Midnight Slumber Mist',
    emoji: '😴',
    vibe: 'Quiet starlit repose and deep drift',
    pageBgGradient: 'from-indigo-50/90 via-slate-50/40 to-blue-50/50',
    containerBg: 'bg-[#F9F9FE]',
    borderColor: 'border-indigo-200/70',
    headerBg: 'bg-[#F9F9FE]/92',
    navBg: 'bg-[#F9F9FE]/95',
    accentColor: '#4F46E5',
    accentBg: 'bg-indigo-100/80',
    accentBorder: 'border-indigo-300',
    accentText: 'text-indigo-950',
    auraColor1: 'rgba(99, 102, 241, 0.18)',
    auraColor2: 'rgba(129, 140, 248, 0.12)',
    pillColor: 'bg-indigo-100 text-indigo-900 border-indigo-300',
  },
  romantic: {
    id: 'romantic',
    name: 'Blushing Blossom Breeze',
    emoji: '🥰',
    vibe: 'Warm affectionate flutter and sweet care',
    pageBgGradient: 'from-pink-50/90 via-rose-50/40 to-fuchsia-50/40',
    containerBg: 'bg-[#FFF9FB]',
    borderColor: 'border-pink-200/70',
    headerBg: 'bg-[#FFF9FB]/92',
    navBg: 'bg-[#FFF9FB]/95',
    accentColor: '#DB2777',
    accentBg: 'bg-pink-100/80',
    accentBorder: 'border-pink-300',
    accentText: 'text-pink-950',
    auraColor1: 'rgba(236, 72, 153, 0.18)',
    auraColor2: 'rgba(244, 114, 182, 0.12)',
    pillColor: 'bg-pink-100 text-pink-900 border-pink-300',
  },
  sick: {
    id: 'sick',
    name: 'Gentle Eucalyptus Healing',
    emoji: '🤒',
    vibe: 'Restful soothing recovery and tender healing',
    pageBgGradient: 'from-teal-50/90 via-emerald-50/30 to-cyan-50/40',
    containerBg: 'bg-[#F8FCFB]',
    borderColor: 'border-teal-200/70',
    headerBg: 'bg-[#F8FCFB]/92',
    navBg: 'bg-[#F8FCFB]/95',
    accentColor: '#0D9488',
    accentBg: 'bg-teal-100/80',
    accentBorder: 'border-teal-300',
    accentText: 'text-teal-950',
    auraColor1: 'rgba(20, 184, 166, 0.18)',
    auraColor2: 'rgba(45, 212, 191, 0.12)',
