  ...
  return (
    <div className="flex-1 flex flex-col pb-6 space-y-4">
      ...
      {notificationService.isSupported() && pushPermission !== 'granted' && (
        <div className="p-3.5 rounded-2xl bg-amber-50/90 border border-amber-300 shadow-2xs flex items-center justify-between gap-3">
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-xl bg-amber-600 hover:bg-amber-700 text-white text-xs font-bold shrink-0 shadow-2xs active:scale-95 transition-all cursor-pointer flex items-center gap-1.5"
          >
      ...
      {pushPermission === 'granted' && (
        <div className="px-3 py-2 rounded-xl bg-emerald-50/80 border border-emerald-200 shadow-2xs flex items-center gap-1.5 text-xs text-emerald-800 font-bold">
