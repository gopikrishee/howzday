      ...
      <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-slate-900/60 backdrop-blur-xs">
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-slate-50/40">
            {/* Quick Link to Dedicated Monthly Insights Screen */}
            <button
              type="button"
              id="history-open-insights-screen-btn"
              onClick={() => {
                onClose();
                onOpenInsightsScreen?.();
              }}
              className="w-full p-3 rounded-2xl bg-gradient-to-r from-indigo-50 via-purple-50 to-amber-50 border border-indigo-200/90 flex items-center justify-between text-left hover:border-indigo-300 active:scale-98 transition-all cursor-pointer shadow-2xs group"
            >
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <p className="text-xs font-black text-indigo-950">
                    Open Monthly Insights Screen
                  </p>
                  <p className="text-[11px] font-medium text-indigo-700/80">
                    View AI emotional patterns & weather archetype
                  </p>
                </div>
              </div>
