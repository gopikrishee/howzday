...
import { Smile, Activity, Users, Sparkles } from 'lucide-react';
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`relative flex flex-col items-center justify-center py-2 px-1.5 rounded-2xl transition-all duration-300 cursor-pointer select-none min-h-[50px] ${
                isActive
